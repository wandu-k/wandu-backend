    ...
    public List<BgmListDto> getBgmList(Long playlistId) {
        ...
        for (BgmList bgmList : list) {
            ...
            BgmListDto bgmListDto = BgmListDto.builder()
                    .itemId(bgmList.getBgmListId()
                            .getBuyItem()
                            .getItemId())
                    .playlistId(bgmList.getBgmListId().getPlaylist().getPlaylistId())
                    .url(fileUrl)
                    .title(bgmList.getBgmListId().getBuyItem().getShop().getItemName())
                    .album(bgmList.getBgmListId().getBuyItem().getShop().getItemFile().getThumbnail())
                    .artist(bgmList.getBgmListId().getBuyItem().getShop().getUserDo().getNickname())
                    .build();
